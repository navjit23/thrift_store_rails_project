...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference("Price.count") do
      post prices_url, params: { price: { from_date: @price.from_date, price: @price.price, product_id: @price.product_id, to_date: @price.to_date } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { from_date: @price.from_date, price: @price.price, product_id: @price.product_id, to_date: @price.to_date } }
